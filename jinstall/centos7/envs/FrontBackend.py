...
class FrontBackend(SyBase):
    def __init__(self):
        ...
        self._steps = {
            ...
            11: SyLinux.install_pcre,
            12: SyLinux.install_nghttp2,
            13: SyLinux.install_jpeg,
            14: SyLinux.install_imagemagick,
            15: SyLinux.install_font,
            16: SyLinux.install_jemalloc,
            17: SyLinux.install_libmaxminddb,
            18: SyNginx.install_openresty,
            19: SyLua.install_luarocks,
            20: SyCache.install_memcache_server,
            21: SyCache.install_memcache_lib,
            22: SyMq.install_rabbit_lib,
            23: SyPhp.install_php7,
            24: SyCache.install_redis,
            25: SyJava.install_java,
            26: SyLinux.install_inotify,
            27: SyLinux.install_etcd,
            28: SyJs.install_nodejs,
            29: SyDb.install_mongodb,
            30: SyCpp.install_boost,
            31: SyDb.install_mysql
        }
