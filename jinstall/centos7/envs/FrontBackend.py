...
class FrontBackend(SyBase):
    def __init__(self):
        ...
        self._configs_profile = [
            ...
            'export PATH=\$PATH:/usr/local/bin:/usr/local/cmake/bin:/usr/local/git/bin:/usr/local/openresty/bin:/usr/local/glibc/bin:\$ER_LANG/bin:\$NODE_HOME/bin:\$JAVA_HOME/bin:\$JAVA_HOME/jre/bin',
        ]
        self._ports = [
            '21/tcp',
            '22/tcp',
        ...
        self._steps = {
            ...
            29: SyJava.install_java,
            30: SyLinux.install_inotify,
            31: SyLinux.install_etcd,
            32: SyJs.install_nodejs,
            33: SyDb.install_mongodb,
            34: SyCpp.install_boost,
            35: SyDb.install_mysql
        }
