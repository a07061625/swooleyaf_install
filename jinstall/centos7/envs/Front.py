...
class Front(SyBase):
    def __init__(self):
        ...
        self._steps = {
            ...
            15: SyLua.install_luarocks,
            16: SyCache.install_memcache_server,
            17: SyCache.install_memcache_lib,
            18: SyMq.install_rabbit_lib,
            19: SyPhp.install_php7,
            20: SyJava.install_java,
            21: SyJs.install_nodejs
        }
